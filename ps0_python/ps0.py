...
img1_green_normed = cv2.add(cv2.multiply(cv2.divide(cv2.subtract(img1_green_normed, mean), std), 10), mean)
...
img1_sub_shifted = img1_shifted - cv2.warpAffine(img1_shifted, M, (cols, rows))
...
# display images one after each button press
cv2.imshow('img1', img1)
cv2.waitKey(0)
cv2.imshow('img2', img2)
cv2.waitKey(0)
cv2.imshow('img1_swapped', img1_swapped)
cv2.waitKey(0)
cv2.imshow('img1_mono_green', img1_green)
cv2.waitKey(0)
cv2.imshow('img1_mono_red', img1_red)
cv2.waitKey(0)
cv2.imshow('img1_with_img2_crop', img2_mono)
cv2.waitKey(0)
cv2.imshow('img1_green_normed', img1_green_normed)
cv2.waitKey(0)
cv2.imshow('img1_shifted', img1_shifted)
cv2.waitKey(0)
cv2.imshow('img1_sub_shifted', img1_sub_shifted)
cv2.waitKey(0)
cv2.imshow('img_green_noise', img_green_noise)
cv2.waitKey(0)
cv2.imshow('img_blue_noise', img_blue_noise)
cv2.waitKey(0)
